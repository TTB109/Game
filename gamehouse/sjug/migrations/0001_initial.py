...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Cde',
            fields=[
                ('cde', models.OneToOneField(db_column='id_cde', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='sjug.Usuario', verbose_name='Identificador de CDE')),
